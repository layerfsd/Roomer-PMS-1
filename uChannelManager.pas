...
type
  TfrmChannelManager = class(TForm)
    ...
    m_webserviceUsername: TStringField;
    m_webservicePassword: TStringField;
    m_webserviceHotelCode: TStringField;
    m_weserviceRequestor: TStringField;
    m_adminUsername: TStringField;
    m_adminPassword: TStringField;
