...
type
  TfrmDynamicPricing = class(TForm)
    ...
    btnEdit: TsButton;
    btnDelete: TsButton;
    m_ROOMTYPEGROUP_CODE: TStringField;
    m_Rate_Name: TStringField;
    m_CHANNEL_MANAGER_ID: TStringField;
    m_ChannelManagerName: TStringField;
    m_CHANNEL_ID: TStringField;
    ...
    m_VAL: TFloatField;
    m_APPLICATION_STRATEGY: TStringField;
