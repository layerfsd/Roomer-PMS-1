...
type
  TfrmReservationProfile = class(TForm)
    ...
    mGuestRoomsRoom: TStringField;
    mGuestRoomsRoomDescription: TStringField;
    mGuestRoomsEquipments: TStringField;
    mGuestRoomsNoRoom: TBooleanField;
    mGuestRoomsRoomType: TStringField;
    mGuestRoomsRoomTypeDescription: TStringField;
    mGuestRoomsDefNumberGuests: TIntegerField;
    mGuestRoomsFloor: TIntegerField;
    mGuestRoomsLocation: TStringField;
    mGuestRoomsLocationDescription: TStringField;
    mRoomsDS: TDataSource;
    mGuestsPID: TStringField;
    mGuestRoomsMainGuest: TStringField;
    ...
    mAllGuestsRoom: TStringField;
    mAllGuestsRoomDescription: TStringField;
    mAllGuestsEquipments: TStringField;
    mAllGuestsNoRoom: TBooleanField;
    mAllGuestsRoomType: TStringField;
    mAllGuestsRoomTypeDescription: TStringField;
    mAllGuestsDefNumberGuests: TIntegerField;
    mAllGuestsFloor: TIntegerField;
    mAllGuestsLocation: TStringField;
    mAllGuestsLocationDescription: TStringField;
    mAllGuestsPerson: TIntegerField;
    mAllGuestsGuestName: TStringField;
    mAllGuestsAddress1: TStringField;
    mAllGuestsAddress2: TStringField;
    mAllGuestsAddress3: TStringField;
    mAllGuestsAddress4: TStringField;
    mAllGuestsCountry: TStringField;
    mAllGuestsPID: TStringField;
    mAllGuestsDS: TDataSource;
    mAllGuestsStatus: TStringField;
    mAllGuestsStatusText: TStringField;
    mGuestRoomsStatus: TStringField;
    mGuestRoomsStatusText: TStringField;
    ...
    pnlDataWait: TsPanel;
    sLabel2: TsLabel;
    mRoomsRoomClass: TStringField;
    tvRoomsRoomClass: TcxGridDBColumn;
    mRoomsRoomClassDescription: TStringField;
    ...
    mRoomsratePlanCode: TStringField;
    ...
    mRoomsExpectedTimeOfArrival: TStringField;
    mRoomsExpectedCheckoutTime: TStringField;
    ...
    mRoomsblockMoveReason: TStringField;
