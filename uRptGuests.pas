...
//  kbmGuests.FieldDefs.Add('ReservationName', ftString, 60);
//  kbmGuests.FieldDefs.Add('Arrival', ftDate);
//  kbmGuests.FieldDefs.Add('Departure', ftDate);
//  kbmGuests.FieldDefs.Add('Room', ftString, 20);
//  kbmGuests.FieldDefs.Add('RoomType', ftString, 20);
//  kbmGuests.FieldDefs.Add('Status', ftString, 5);
//  kbmGuests.FieldDefs.Add('Breakfast', ftBoolean);
//  kbmGuests.FieldDefs.Add('RoomDescription', ftString, 60);
//  kbmGuests.FieldDefs.Add('Location', ftString, 30);
//  kbmGuests.FieldDefs.Add('Floor', ftInteger);
//  kbmGuests.FieldDefs.Add('Equipments', ftString, 80);
//  kbmGuests.FieldDefs.Add('LocationDescription', ftString, 60);
//  kbmGuests.FieldDefs.Add('GroupAccount', ftBoolean);
//  kbmGuests.FieldDefs.Add('marketSegment', ftString, 15);
//  kbmGuests.FieldDefs.Add('marketSegmentDescription', ftString, 60);
//  kbmGuests.FieldDefs.Add('Email', ftString, 200);
//  kbmGuests.FieldDefs.Add('Customer', ftString, 30);
//  kbmGuests.FieldDefs.Add('CustomerName', ftString, 60);
//  kbmGuests.FieldDefs.Add('PersonalID', ftString, 15);
//  kbmGuests.FieldDefs.Add('Statustext', ftString, 50);
//  kbmGuests.FieldDefs.Add('resInfo', ftString, 120);
...
//  kbmGuests.FieldDefs.Add('GuestName', ftString, 150);
//  kbmGuests.FieldDefs.Add('isMain', ftBoolean);
//  kbmGuests.FieldDefs.Add('Channel', ftString, 50);
...
//  kbmGuests.FieldDefs.Add('Currency', ftString, 5);
