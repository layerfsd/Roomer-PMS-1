...
type
  ...
  TfrmItems2 = class(TForm)
    ...
    m_ItemsItem: TStringField;
    m_ItemsMinibarItem: TBooleanField;
    m_ItemsDescription: TStringField;
    m_ItemsPrice: TFloatField;
    m_ItemsItemtype: TStringField;
    m_ItemsAccountKey: TStringField;
    ...
    m_ItemsBookKeepCode: TStringField;
    tvDataBookKeepCode: TcxGridDBColumn;
    timFilter: TTimer;
    m_ItemsNumberBase: TStringField;
