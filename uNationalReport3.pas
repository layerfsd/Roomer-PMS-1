...
type
  TfrmNationalReport3 = class(TForm)
    ...
    mHagstofa1Country: TStringField;
    mHagstofa1CountryName: TStringField;
    mHagstofa1Nights: TIntegerField;
    mHagstofa1CountryGroup: TStringField;
    mHagstofa1GroupName: TStringField;
    ...
    grAllGuests: TcxGrid;
    mAllGuestsReservationCountry: TStringField;
    ...
    mAllGuestsGuestsCountry: TStringField;
    mAllGuestsGuestCountryName: TStringField;
    mAllGuestsGuestGroupName: TStringField;
    ...
    mAllGuestsReservationsName: TStringField;
