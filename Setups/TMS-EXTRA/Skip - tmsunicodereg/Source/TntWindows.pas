...
{$IFNDEF DELPHI_XE3}
  Tnt_SHGetFileInfoW: function(pszPath: PWideChar; dwFileAttributes: DWORD; var psfi: TSHFileInfoW; cbFileInfo, uFlags: UINT): Cardinal; stdcall = SHGetFileInfo;
{$ENDIF}
{$IFDEF DELPHI_XE3}
  Tnt_SHGetFileInfoW: function(pszPath: PWideChar; dwFileAttributes: DWORD; var psfi: TSHFileInfoW; cbFileInfo, uFlags: UINT): DWORD_PTR; stdcall = SHGetFileInfo;
{$ENDIF}
