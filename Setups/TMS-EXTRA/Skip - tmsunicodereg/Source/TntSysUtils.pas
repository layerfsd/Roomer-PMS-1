...
{                                                                           }
{ Copyright © 2007 - 2011 by TMS software                                   }
...
var
  ...
  {$IFDEF DELPHI_XE}
  WideDirectoryExists: function (const S: string; FollowLink: boolean = true): Boolean = DirectoryExists;
  {$ENDIF}
  {$IFNDEF DELPHI_XE}
  WideDirectoryExists: function (const S: string): Boolean = DirectoryExists;
  {$ENDIF}
  {$IFDEF DELPHI_XE}
  WideFileExists: function (const S: string; FollowLink: boolean = true): Boolean = FileExists;
  {$ENDIF}
  {$IFNDEF DELPHI_XE}
  ...
  WideRenameFile: function(const OldName, NewName: string): Boolean = RenameFile;
  ...
  {$IFDEF DELPHI_XE2}
  WideFileCreate: function(const FileName: string): NativeUInt = FileCreate;
  WideFileOpen: function(const FileName: string; Mode: Longword): NativeUInt = FileOpen;
  {$ENDIF}
  {$IFNDEF DELPHI_XE2}
  WideFileCreate: function(const FileName: string): Integer = FileCreate;
  WideFileOpen: function(const FileName: string; Mode: Longword): Integer = FileOpen;
  {$ENDIF}

  WideFileAge: function(const FileName: string): Integer = FileAge;

  {$IFDEF DELPHI_XE}
  WideFileGetAttr: function(const FileName: string; FollowLink: boolean = True): Integer = FileGetAttr;
  {$ENDIF}
  {$IFNDEF DELPHI_XE}
  WideFileGetAttr: function(const FileName: string): Integer = FileGetAttr;
  {$ENDIF}
  {$IFDEF DELPHI_XE}
  WideFileSetAttr: function(const FileName: string; Attr: Integer; FollowLink: boolean = true): Integer = FileSetAttr;
  {$ENDIF}
  {$IFNDEF DELPHI_XE}
  WideFileSetAttr: function(const FileName: string; Attr: Integer): Integer = FileSetAttr;
  {$ENDIF}
