...
{TNT-WARN TToolBar}
  ...
  private
    ...
    FCaption: WideString;
    {$IFDEF DELPHI_UNICODE}
    function GradientDrawButton(Button: TToolButton; State: TCustomDrawState; var
        Flags: TTBCustomDrawFlags): Boolean; override;
    {$ENDIF}
...
uses
  ...
  RichEdit, ActiveIMM_TLB, TntForms, ComStrs, TntMenus, GraphUtil,
  TntActnList, TntStdActns, TntWindows, ExtCtrls,
...
destructor TTntToolBar.Destroy;
begin
  inherited;
  FreeAndNil(FBitmap);
end;
...
{$IFDEF DELPHI_UNICODE}
function TTntToolBar.GradientDrawButton(Button: TToolButton; State:
    TCustomDrawState; var Flags: TTBCustomDrawFlags): Boolean;
const
  cInset = 4;
var
  FillColor: TColor;
...
begin
  ...
  begin
    ...
    GradientFillCanvas(FBitmap.Canvas, GradientStartColor, GradientEndColor,
  ...
  begin
    FBitmap.SetSize(Button.Width, Button.Height);
    FBitmap.Canvas.Brush.Color := TTntToolButton(Button).Color;
  ...
  begin
    ...
    begin
      ...
      FBitmap.Canvas.Pen.Color := TTntToolbutton(Button).Font.Color;
      if not Button.Enabled then
    ...
    begin
      ...
      Str := TTntToolbar(Button).Caption;
      ...
      FBitmap.Canvas.Font.Color := TTntToolButton(Button).Font.Color;
      if not Button.Enabled then
        FBitmap.Canvas.Font.Color := clGrayText;

      DrawTextW(FBitmap.Canvas.Handle, PWideChar(Str), Length(Str), R,
