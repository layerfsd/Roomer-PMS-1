...
//  acAbbr = AnsiString('ASzf');
  acAbbr: array [1..4] of AnsiChar = 'ASzf';
...
procedure GetFiles(const DirPath, FileExt: acString; FileList: TStringList); {$IFDEF WARN_DEPRECATED} deprecated; {$ENDIF}
var
  Status: THandle;
