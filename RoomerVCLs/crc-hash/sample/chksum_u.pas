(*************************************************************************
 ...
 REQUIREMENTS    :  D2-D7/D9-D10/D12

 EXTERNAL DATA   :  CH_DLL.DLL for {$ifdef usedll}
...
uses
  ...
  StdCtrls, Buttons, ExtCtrls, ComCtrls, IniFiles, Mem_Util,clipbrd;
...
procedure TCS_Main.SB_InfoClick(Sender: TObject);
  {-Show info}
begin
   MessageDlg( 'GCH Version '+XVersion+'  (c) 2002-2012  W.Ehrhardt'+#13+#10
