...
{$ifdef UseWinDOS}
var
  buf: array[1..$7400] of byte;  {BP7Win: data segment too large!!}
{$else}
{$ifdef VER80}
var
  buf: array[1..$5000] of byte;  {D1: data segment too large!!}
{$else}
var
  buf: array[1..$B000] of byte;
{$endif}
{$endif}
...
var
  ...
  {$endif}
begin
  writeln('CCH V', CCH_Version, '  -  Calculate CRC/Hash   (c) 2002-2012 W.Ehrhardt');
  n := 0;
