...
type
  TfrmCustomers2 = class(TForm)
    ...
    m_Customer: TStringField;
    m_Surname: TStringField;
    m_Name: TStringField;
    m_CustomerType: TStringField;
    m_Address1: TStringField;
    m_Address2: TStringField;
    m_Address3: TStringField;
    m_Address4: TStringField;
    m_Country: TStringField;
    m_Tel1: TStringField;
    m_Tel2: TStringField;
    m_FAX: TStringField;
    m_DiscountPercent: TFloatField;
    m_EmailAddress: TStringField;
    ...
    btnEdit: TsButton;
    sButton1: TsButton;
    m_CountryName: TStringField;
    m_CustomerTypeDescription: TStringField;
    ...
    mMemoDS: TDataSource;
    mMemo_Description: TStringField;
