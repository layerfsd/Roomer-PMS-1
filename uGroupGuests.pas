...
type
  TfrmGroupGuests = class(TForm)
    ...
    mGueststitle: TStringField;
    mGuestsName: TStringField;
    mGuestsAddress1: TStringField;
    mGuestsAddress2: TStringField;
    mGuestsAddress3: TStringField;
    mGuestsAddress4: TStringField;
    mGuestsCountry: TStringField;
    mGueststel1: TStringField;
    mGueststel2: TStringField;
    mGuestsFax: TStringField;
    mGuestsEmail: TStringField;
    mGuestsNationality: TStringField;
    mGuestsPID: TStringField;
    mGuestsMainName: TBooleanField;
    mGuestsCustomer: TStringField;
    mGuestsState: TStringField;
    mGuestsPersonalIdentificationId: TStringField;
    mGuestsDateOfBirth: TDateTimeField;
    mGuestsSocialSecurityNumber: TStringField;
    ...
    mGuestsroomDetails: TStringField;
    mGuestsCompanyName: TStringField;
    mGuestsCompVATNumber: TStringField;
    mGuestsCompAddress1: TStringField;
    mGuestsCompAddress2: TStringField;
    mGuestsCompZip: TStringField;
    mGuestsCompCity: TStringField;
    mGuestsCompCountry: TStringField;
    mGuestsCompTel: TStringField;
    mGuestsCompFax: TStringField;
    mGuestsCompEmail: TStringField;
    ...
    WideStringField2: TStringField;
    WideStringField3: TStringField;
    WideStringField4: TStringField;
    WideStringField5: TStringField;
    WideStringField6: TStringField;
    WideStringField7: TStringField;
    WideStringField8: TStringField;
    WideStringField9: TStringField;
    WideStringField10: TStringField;
    WideStringField11: TStringField;
    WideStringField12: TStringField;
    WideStringField13: TStringField;
    BooleanField1: TBooleanField;
    WideStringField14: TStringField;
    WideStringField15: TStringField;
    WideStringField16: TStringField;
    DateTimeField1: TDateTimeField;
    WideStringField17: TStringField;
    WideStringField18: TStringField;
    BooleanField2: TBooleanField;
    DateTimeField2: TDateTimeField;
    DateTimeField3: TDateTimeField;
    IntegerField6: TIntegerField;
    WideStringField19: TStringField;
    WideStringField20: TStringField;
    WideStringField21: TStringField;
    StringField1: TStringField;
    WideStringField22: TStringField;
    StringField2: TStringField;
    WideStringField23: TStringField;
    WideStringField24: TStringField;
    WideStringField25: TStringField;
    WideStringField26: TStringField;
    WideStringField27: TStringField;
    WideStringField28: TStringField;
    WideStringField29: TStringField;
    WideStringField30: TStringField;
