...
type
  TfrmDayFinical = class(TForm)
    ...
    mItemSaleDescription: TStringField;
    mItemSaleAccountKey: TStringField;
    mItemSaleItemType: TStringField;
    mItemSaleItemTypeDescription: TStringField;
    mItemSaleVATCode: TStringField;
    ...
    Panel5: TsPanel;
    mInvoiceLinesPurchaseDate: TStringField;
    ...
    mPaymentTypesPayType: TStringField;
    mPaymentTypesPayTypeDescription: TStringField;
    ...
    mPaymentTypesPayGroup: TStringField;
    ...
    mSumsCode: TStringField;
    mSumsDescription: TStringField;
    ...
    mPaymentGroupsDescription: TStringField;
    ...
    mItemVATsaleDescription: TStringField;
    ...
    mInvoiceHeadsCurrency: TStringField;
    mInvoiceHeadsRate: TFloatField;
    mInvoiceHeadsStaff: TStringField;
    mInvoiceHeadsCustomerName: TStringField;
    mInvoiceHeadsisAgency: TBooleanField;
    mInvoiceHeadsmarkedSegment: TStringField;
    mInvoiceHeadsmarkedSegmentDescription: TStringField;
