object FrmEmailExcelSheet: TFrmEmailExcelSheet
  Left = 0
  Top = 0
  Caption = 'FrmEmailExcelSheet'
  ClientHeight = 663
  ClientWidth = 999
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object Excel: TcxSpreadSheetBook
    Left = 0
    Top = 327
    Width = 999
    Height = 295
  ...
  object sPanel1: TsPanel
    ...
    object sLabel5: TsLabel
      ...
      Height = 13
      Caption = 
        'Attached Excel sheet below. Please feel free to make any changes' +
  ...
  object StoreMain: TcxPropertiesStore
    ...
    StorageName = 'Software\Roomer\FormStatus\RateChangesEmailingDialog'
