...
type
  TfrmTaxes = class(TForm)
    ...
    m_Tax_Type: TStringField;
    m_Tax_Base: TStringField;
    m_Time_Due: TStringField;
    m_ReTaxable: TStringField;
    ...
    m_Hotel_Id: TStringField;
    m_Booking_Item: TStringField;
    m_Incl_Excl: TStringField;
    tvDataIncl_Excl: TcxGridDBColumn;
    tvDataNetto_Amount_Based: TcxGridDBColumn;
    m_Netto_Amount_Based: TStringField;
    pnlHolder: TsPanel;
    m_Value_Formula: TStringField;
